    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (groupIdParam == null) {
                res.sendError(400, "Missing groupId");
                return;
            }
            ...
            try (Connection conn = DBConnection.getConnection()) {
                ...
                try (PreparedStatement ps1 = conn.prepareStatement(groupSql)) {
                ...
                try (PreparedStatement ps2 = conn.prepareStatement(memberSql)) {
                ...
                try (PreparedStatement ps3 = conn.prepareStatement(activeExpenseSql)) {
                ...
                try (PreparedStatement ps4 = conn.prepareStatement(settledExpenseSql)) {
                ...
                try (PreparedStatement ps5 = conn.prepareStatement(balanceSql)) {
                    for (int i = 1; i <= 5; i++) {
            ...
            e.printStackTrace();
            res.sendError(400, "Invalid groupId");
